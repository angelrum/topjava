...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <button class="btn btn-primary btn-mini" type="submit" onclick="filter()"><spring:message code="meal.filter"/></button>
            <button class="btn btn-primary btn-mini" type="submit" onclick="updateTable()"><spring:message code="meal.clear"/></button>
        </div>
        <hr>
            ...
            <div class="modal-body">
                <form id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" size="40" id="description" name="description" required
